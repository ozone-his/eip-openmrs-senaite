    ...
    private void setupExpectations() {
    	fetchcanceledOrderFromSenaiteEndpoint.whenAnyExchangeReceived(new Processor () {
			...
			public void process(Exchange exchange) throws Exception {
				exchange.getIn().setBody("{\"count\":0,\"pagesize\":25,\"items\":[],\"page\":1,\"_runtime\":0.005473136901855469,\"next\":null,\"pages\":1,\"previous\":null}");
			}
    		
    	});
    	fetchcanceledOrderFromSenaiteEndpoint.expectedHeaderReceived(Exchange.HTTP_METHOD, "GET");
    	
    	fetchActiveOrderFromSenaiteEndpoint.whenAnyExchangeReceived(new Processor () {
			@Override
			public void process(Exchange exchange) throws Exception {
