...
public class CreateAnalysisRequestToSenaiteRouteITest extends BaseCamelRoutesTest {
    ...
    public void setup() throws Exception {
        ...
        advise("create-analysisrequest-to-senaite", new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                weaveByToString(
                                ".*/@@API/senaite/v1/search\\?getClientSampleID=\\$\\{exchangeProperty.lab-order-uuid\\}\\&getClientID=\\$\\{exchangeProperty.patient-id\\}\\&catalog=senaite_catalog_sample\\&complete=true]")
                        .replace()
                        .toD("mock:searchAnalysisRequestSenaiteEndpoint");
                weaveByToString(
                                ".*/@@API/senaite/v1/search\\?complete=true\\&Description=\\$\\{exchangeProperty.service-analysis-template\\}\\&catalog=senaite_catalog_setup\\&portal_type=ARTemplate]")
                        .replace()
                        .toD("mock:searchAnalysisRequestTemplateSenaiteEndpoint");
                weaveByToString(".*/@@API/senaite/v1/AnalysisRequest/create/\\$\\{exchangeProperty.client-uid\\}]")
                        .replace()
                        .toD("mock:createAnalysisRequestSenaiteEndpoint");
            }
        });
    ...
    @Test
    public void shouldCreateSenaiteAnalysisRequestFromOpenmrsTestOrderPanelGivePatientAlreadyExistsInSenaite()
            throws Exception {
        // setup
        ...
        searchAnalysisRequestSenaiteEndpoint.whenAnyExchangeReceived(new Processor() {
            ...
            public void process(Exchange exchange) throws Exception {
                ...
                if ("8ee73df9-b80e-49d9-9fd1-8a5b6864178f".equals(exchange.getProperty("lab-order-uuid"))
                        && "86f0b43e-12a2-4e98-9937-6c85d8f05d65".equals(exchange.getProperty("patient-id"))) {
                    exchange.getIn()
                            .setBody(
                                    "{\"count\":0,\"pagesize\":25,\"items\":[],\"page\":1,\"_runtime\":0.0029439926147460938,\"next\":null,\"pages\":1,\"previous\":null}");
                }
            }
        });
        searchAnalysisRequestSenaiteEndpoint.expectedHeaderReceived(Exchange.HTTP_METHOD, "GET");
        searchAnalysisRequestSenaiteEndpoint.expectedPropertyReceived(
                "lab-order-uuid", "8ee73df9-b80e-49d9-9fd1-8a5b6864178f");
        searchAnalysisRequestSenaiteEndpoint.expectedPropertyReceived(
                "patient-id", "86f0b43e-12a2-4e98-9937-6c85d8f05d65");
