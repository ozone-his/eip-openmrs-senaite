...
public class CreateContactToSenaiteRouteITest extends BaseCamelRoutesTest {
    ...
    public void setup() throws Exception {
        ...
        advise("create-contact-to-senaite", new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                weaveByToString(
                                ".*@@API/senaite/v1/search\\?limit=10000&depth=2\\&path=\\$\\{exchangeProperty.client-storage-path\\}]")
                        .replace()
                        .toD("mock:searchClientContactSenaiteEndpoint");
            }
        });
    ...
    public void shouldCreateContactInSenaite() throws Exception {
        ...
        searchClientContactSenaiteEndpoint.whenAnyExchangeReceived(
                exchange1 -> exchange1
                        .getIn()
                        .setBody(
    ...
    private void setupExpectations() {
        ...
        createSenaiteEndpoint.expectedBodiesReceived(
                "{\"portal_type\": \"Contact\",\"parent_path\": \"/senaite/clients/client-1\",\"Firstname\": \"Super\",\"Surname\": \"Man\"}");
