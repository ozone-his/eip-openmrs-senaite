...
public class ListenToOpenmrsITest extends BaseCamelRoutesTest {
    ...
    public void setup() throws Exception {
        ...
        advise("openmrs-to-senaite-event-listener", new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                weaveByToString("To[direct:retrieve-patient-names-from-openmrs]")
                        .replace()
                        .toD("mock:retrievePatientNamesRoute");
                weaveByToString("To[direct:retrieve-orderer-names-from-openmrs]")
                        .replace()
                        .toD("mock:retrievePontacttNamesRoutee");
                weaveByToString("To[direct:retrieve-patient-id-from-openmrs]")
                        .replace()
                        .toD("mock:retrievePatientId");
                weaveByToString("To[direct:create-client-to-senaite]").replace().toD("mock:createClientToSenaiteRoute");
                weaveByToString("To[direct:create-contact-to-senaite]")
                        .replace()
                        .toD("mock:createContactToSenaiteRoute");
                weaveByToString("To[direct:create-analysisrequest-to-senaite]")
                        .replace()
                        .toD("mock:createAnalysisRequestToSenaite");
                weaveByToString("To[direct:create-servicerequest-task-to-openmrs]")
                        .replace()
                        .toD("mock:createServiceRequestTasktoOpenmrs");
                weaveByToString(
                                ".*/ServiceRequest/\\$\\{exchangeProperty.lab-order-uuid\\}\\?throwExceptionOnFailure=false]")
                        .replace()
                        .toD("mock:openmrsFhirServiceRequestEndpoint");
            }
        });
    ...
    public void shouldCreateSenaiteAnalysisRequestFromOpenmrsTestOrderPanelGivenNewActiveOrder() throws Exception {
        ...
        // replay
        producerTemplate.send("direct:openmrs-to-senaite-event-listener", exchange);
    ...
    private void setupExpectations() {
        ...
        retrievePatientNamesRoute.expectedPropertyReceived(
                "service-analysis-template", "ab3b5775-7080-4cb1-8be5-54e367940145");
        retrievePatientNamesRoute.expectedPropertyReceived("lab-order-start-date", "2021-11-29T13:13:48+00:00");
        retrievePatientNamesRoute.expectedPropertyReceived(
                "patient-reference", "Patient/0298aa1b-7fa1-4244-93e7-c5138df63bb3");
        retrievePatientNamesRoute.expectedPropertyReceived(
        ...
        retrievePontacttNamesRoute.expectedPropertyReceived(
                "service-analysis-template", "ab3b5775-7080-4cb1-8be5-54e367940145");
        ...
        createClientToSenaiteRoute.expectedPropertyReceived(
                "service-analysis-template", "ab3b5775-7080-4cb1-8be5-54e367940145");
        ...
        createContactToSenaiteRoute.expectedPropertyReceived(
                "service-analysis-template", "ab3b5775-7080-4cb1-8be5-54e367940145");
        ...
        createAnalysisRequestToSenaite.expectedPropertyReceived(
                "service-analysis-template", "ab3b5775-7080-4cb1-8be5-54e367940145");
        ...
        createServiceRequestTasktoOpenmrs.expectedPropertyReceived(
                "service-analysis-template", "ab3b5775-7080-4cb1-8be5-54e367940145");
