...
@MockEndpoints
public class RetrievePatientIdRouteITest extends BaseCamelRoutesTest {
    ...
    public void setup() throws Exception {
        ...
        advise("retrieve-patient-id-from-openmrs", new AdviceWithRouteBuilder() {
            ...
            public void configure() {
                ...
                weaveByToString(".*/\\$\\{exchangeProperty.patient-reference\\}]")
                        .replace()
                        .toD("mock:patientEndpoint");
            }
        });
        setupExpectations();
    }
    ...
    public void shouldSetFamilyAndGivenPatientNames() throws Exception {
        ...
        // replay
        producerTemplate.send("direct:retrieve-patient-id-from-openmrs", exchange);
