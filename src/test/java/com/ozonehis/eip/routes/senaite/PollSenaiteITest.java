...
public class PollSenaiteITest extends BaseCamelRoutesTest {
	...
	private void setupExpectations() {
		fetchServiceRequestTasksRoute.whenAnyExchangeReceived(exchange -> exchange.getIn().setBody(
		...
		serviceRequestEndpoint.whenAnyExchangeReceived(exchange -> exchange.getIn().setBody(
		...
		encounterEndpoint.whenAnyExchangeReceived(exchange -> exchange.getIn().setBody(
        ...
        retrievePatientId.whenAnyExchangeReceived(exchange -> exchange.setProperty("patient-id", "some-unique-patient-id"));
        retrievePatientId.setResultWaitTime(resultWaitTimeMillis);
		
		analysisRequestSearchEndpoint.whenAnyExchangeReceived(exchange -> exchange.getIn().setBody(
