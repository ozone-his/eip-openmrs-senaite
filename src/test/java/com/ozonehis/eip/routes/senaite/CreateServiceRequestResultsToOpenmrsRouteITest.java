...
public class CreateServiceRequestResultsToOpenmrsRouteITest extends BaseCamelRoutesTest {
    ...
    public void setup() throws Exception {
    	...
    	advise("create-servicerequest-results-to-openmrs", new AdviceWithRouteBuilder() {
    	    ...
    	    public void configure() {
    	    	...
    	    	weaveByToString(".*\\$\\{exchangeProperty.analysis-api_url\\}]").replace().toD("mock:fetchAnalysisRequestSenaiteEndpoint");
    	    	weaveByToString(".*/Observation\\?code=\\$\\{exchangeProperty.service-request-concept-uuid\\}\\&subject=\\$\\{exchangeProperty.patient-uuid\\}\\&encounter=\\$\\{exchangeProperty.results-encounter-uuid\\}\\&date=\\$\\{exchangeProperty.service-request-resultCaptureDate\\}]").replace().toD("mock:searchObservationOpenmrsFhirEndpoint");
    	    	weaveByToString(".*/ws/rest/v1/obs]").replace().toD("mock:createObservationOpenmrsEndpoint");
    	    	weaveByToString(".*/ws/rest/v1/encounter\\?encounterType=.*").replace().toD("mock:searchEncounterOpenmrsEndpoint");
    	    }
    	});
	...
	@NotNull
	private Exchange prepareExchange() throws JsonProcessingException {
	...
	private void setupExpectations() {
    	...
    	createEncounterOpenmrsEndpoint.whenAnyExchangeReceived(
			    exchange -> exchange.getIn().setBody("{\"uuid\":\"40901ffc-954f-4fa9-abc3-5edc02438708\",\"encounterDatetime\":\"2021-12-16T06:26:52.000+0000\",\"patient\":{\"uuid\":\"0298aa1b-7fa1-4244-93e7-c5138df63bb3\"},\"location\":{\"uuid\":\"833d0c66-e29a-4d31-ac13-ca9050d1bfa9\"}}"));
