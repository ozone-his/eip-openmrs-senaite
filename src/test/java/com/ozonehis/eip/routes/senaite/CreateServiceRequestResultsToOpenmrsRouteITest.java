...
public class CreateServiceRequestResultsToOpenmrsRouteITest extends BaseCamelRoutesTest {
    ...
    public void setup() throws Exception {
        loadXmlRoutesInDirectory("camel", "create-servicerequest-results-to-openmrs-route.xml");

        advise("create-servicerequest-results-to-openmrs", new AdviceWithRouteBuilder() {
            @Override
            public void configure() {
                ...
                weaveByToString(".*/ws/rest/v1/encounter]").replace().toD("mock:createEncounterOpenmrsEndpoint");
                weaveByToString(".*\\$\\{exchangeProperty.analysis-api_url\\}]")
                        .replace()
                        .toD("mock:fetchAnalysisRequestSenaiteEndpoint");
                weaveByToString(
                                ".*/Observation\\?code=\\$\\{exchangeProperty.service-request-concept-uuid\\}\\&subject=\\$\\{exchangeProperty.patient-uuid\\}\\&encounter=\\$\\{exchangeProperty.results-encounter-uuid\\}\\&date=\\$\\{exchangeProperty.service-request-resultCaptureDate\\}]")
                        .replace()
                        .toD("mock:searchObservationOpenmrsFhirEndpoint");
                weaveByToString(".*/ws/rest/v1/obs]").replace().toD("mock:createObservationOpenmrsEndpoint");
                weaveByToString(".*/ws/rest/v1/encounter\\?encounterType=.*")
                        .replace()
                        .toD("mock:searchEncounterOpenmrsEndpoint");
            }
        });
    ...
    @NotNull private Exchange prepareExchange() throws JsonProcessingException {
        ...
        exchange.setProperty("service-request-tests", Arrays.toString(testsMapArray));
        return exchange;
    }

    private static Map<String, String>[] getMapArray() throws JsonProcessingException {
        String tests =
        ...
        return mapper.readValue(tests, typeRef);
    }
    ...
    private void setupExpectations() {
        searchEncounterOpenmrsEndpoint.whenAnyExchangeReceived(
                exchange -> exchange.getIn().setBody("{\"results\": []}"));
        ...
        createEncounterOpenmrsEndpoint.whenAnyExchangeReceived(
                exchange -> exchange.getIn()
                        .setBody(
                                "{\"uuid\":\"40901ffc-954f-4fa9-abc3-5edc02438708\",\"encounterDatetime\":\"2021-12-16T06:26:52.000+0000\",\"patient\":{\"uuid\":\"0298aa1b-7fa1-4244-93e7-c5138df63bb3\"},\"location\":{\"uuid\":\"833d0c66-e29a-4d31-ac13-ca9050d1bfa9\"}}"));
        ...
        fetchAnalysisRequestSenaiteEndpoint.whenAnyExchangeReceived(exchange -> {
            String resultEndPoint1 =
                    "http://localhost:8081/senaite/@@API/senaite/v1/analysis/cbbded1109514906a4afe33be29e7df3";
            String resultEndPoint2 =
                    "http://localhost:8081/senaite/@@API/senaite/v1/analysis/adc7f66d99b449e095d1f4771fe88c2a";
            String resultEndPoint3 =
                    "http://localhost:8081/senaite/@@API/senaite/v1/analysis/22a78ae92e214c0fbf821b6d682a231e";
