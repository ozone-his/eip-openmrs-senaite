...
public class InboundLimsRouteITest extends BaseCamelContextSensitiveTest {  
    ...
    private void setupExpectations() {
    	...
    	senaiteAnalysisResultsEndpoint.whenAnyExchangeReceived(new Processor () {
			@Override
			public void process(Exchange exchange) throws Exception {
				if (exchange.getProperty("analysis-api_url") == "http://localhost:8088/senaite/@@API/senaite/v1/analysis/2a5004b0bc224d958dff8c859219b24f") {
				...
				} else if (exchange.getProperty("analysis-api_url") == "http://localhost:8088/senaite/@@API/senaite/v1/analysis/fc3d6f2affa24e2b9a7749893b433a3c") {
