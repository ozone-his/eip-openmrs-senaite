...
public class CreateClientToSenaiteRouteITest extends BaseWatcherRouteTest {  
    ...
    public void shouldSearchAndUseExistingClientInSenaite() throws Exception {
    	...
    	exchange.setProperty("patient-name-unique", "John Smitha (86f0b43e-12a2-4e98-9937-6c85d8f05d65)");
    ...
    public void shouldCreateClientGivenItDoesNotExistsInSenaite() throws Exception {
    	// setup
    	Exchange exchange = new DefaultExchange(camelContext);
    	exchange.setProperty("patient-name-unique", "John Smitha 2 (77a7901-0a73-4849-8c36-fc5a6ae28503)");
    ...
    private void setupExpectations() {
    	searchClientSenaiteEndpoint.whenAnyExchangeReceived(new Processor() {
			...
			public void process(Exchange exchange) throws Exception {
				...
				if ("John Smitha (86f0b43e-12a2-4e98-9937-6c85d8f05d65)".equals(exchange.getProperty("patient-name-unique"))) {
					exchange.getIn().setBody(
							"{\"count\":1,\"items\":[{\"uid\":\"06a29e6454464466876b718466176457\",\"creation_date\":\"2021-11-11T13:43:36+00:00\",\"id\":\"client-1\",\"Name\":\"John Smitha 2 (86e0b43e-12a2-4e98-9937-6c85d8f05d65)\",\"parent_id\":\"clients\",\"api_url\":\"http://127.0.0.1:8088/senaite/@@API/senaite/v1/client/72499009f97847a98a1cb27456a36079\",\"author\":\"admin\",\"ClientID\":\"86e0b43e-12a2-4e98-9937-6c85d8f05d65\",\"portal_type\":\"Client\",\"language\":\"en\",\"path\":\"/senaite/clients/client-1\",\"parent_path\":\"/senaite/clients\",\"created\":\"2021-11-11T13:43:36+00:00\",\"url\":\"http://127.0.0.1:8088/clients/client-1\",\"title\":\"John Smitha (86e0b43e-12a2-4e98-9937-6c85d8f05d65)\",\"modified\":\"2021-11-11T13:43:36+00:00\",\"creators\":[\"admin\"]}],\"url\":\"http://127.0.0.1:8088/senaite/@@API/senaite/v1/create\",\"_runtime\":0.22557592391967773}");
				} else if ("John Smitha 2 (77a7901-0a73-4849-8c36-fc5a6ae28503)".equals(exchange.getProperty("patient-name-unique"))){
    	...
    	createSenaiteEndpoint.expectedBodiesReceived("{\"portal_type\":\"Client\",\"title\":\"John Smitha 2 (77a7901-0a73-4849-8c36-fc5a6ae28503)\",\"ClientID\":\"77a7901-0a73-4849-8c36-fc5a6ae28503\",\"parent_path\":\"/senaite/clients\"}");
    	createSenaiteEndpoint.whenAnyExchangeReceived(new Processor() {
			@Override
			public void process(Exchange exchange) throws Exception {
				exchange.getIn().setBody(
						"{\"count\":1,\"items\":[{\"uid\":\"dce9a10c32c54dabaa5da7a0a29f8ef8\",\"creation_date\":\"2021-11-11T13:43:36+00:00\",\"id\":\"client-1\",\"Name\":\"John Smitha 2 (77a7901-0a73-4849-8c36-fc5a6ae28503)\",\"parent_id\":\"clients\",\"api_url\":\"http://127.0.0.1:8088/senaite/@@API/senaite/v1/client/06a29e6454464466876b718466176457\",\"author\":\"admin\",\"ClientID\":\"77a7901-0a73-4849-8c36-fc5a6ae28503\",\"portal_type\":\"Client\",\"language\":\"en\",\"path\":\"/senaite/clients/client-2\",\"parent_path\":\"/senaite/clients\",\"created\":\"2021-11-11T13:43:36+00:00\",\"url\":\"http://127.0.0.1:8088/clients/client-2\",\"title\":\"John Smitha 2 (86e0b43e-12a2-4e98-9937-6c85d8f05d65)\",\"modified\":\"2021-11-11T13:43:36+00:00\",\"creators\":[\"admin\"]}],\"url\":\"http://127.0.0.1:8088/senaite/@@API/senaite/v1/create\",\"_runtime\":0.22557592391967773}");
			}

		});
    	createSenaiteEndpoint.expectedPropertyReceived("patient-name-unique", "John Smitha 2 (77a7901-0a73-4849-8c36-fc5a6ae28503)");
