...
public class CreateServiceRequestResultsToOpenmrsRouteITest extends BaseWatcherRouteTest {  
    ...
    public void setup() throws Exception {
    	loadXmlRoutesInDirectory("senaite", "create-serviceRequestResults-to-openmrs-route.xml");
    	RouteDefinition routeDefinition = camelContext.adapt(ModelCamelContext.class).getRouteDefinitions().stream().filter(routeDef -> "create-serviceRequestResults-to-openmrs".equals(routeDef.getRouteId())).collect(Collectors.toList()).get(0);
