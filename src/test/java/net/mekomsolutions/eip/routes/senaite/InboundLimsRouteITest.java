...
public class InboundLimsRouteITest extends BaseWatcherRouteTest {
	...
	public void setup() throws Exception {
		loadXmlRoutesInDirectory("senaite", "inbound-lims-route.xml", "openmrs-authenticate-route.xml",
				"senaite-authenticate-route.xml");
		RouteDefinition routeDefinition = camelContext.adapt(ModelCamelContext.class).getRouteDefinitions().stream()
				.filter(routeDef -> "inbound-lims".equals(routeDef.getRouteId())).collect(Collectors.toList()).get(0);
		RouteReifier.adviceWith(routeDefinition, camelContext, new AdviceWithRouteBuilder() {
			@Override
			public void configure() throws Exception {
				weaveByToString("DynamicTo[{{openmrs.baseUrl}}/ws/fhir2/R4/Task?status=requested,accepted]").replace()
						.toD("mock:openmrsFhirTaskSearchEndpoint");
				weaveByToString(
						"DynamicTo[{{openmrs.baseUrl}}/ws/fhir2/R4/ServiceRequest/${exchangeProperty.service-request-id}?throwExceptionOnFailure=false]")
								.replace().toD("mock:openmrsFhirServiceRequestEndpoint");
				weaveByToString(
						"DynamicTo[{{openmrs.baseUrl}}/ws/rest/v1/encounter/${exchangeProperty.service-request-encounter-reference}]")
								.replace().toD("mock:openmrsEncounterApiEndpoint");
				weaveByToString(
						"DynamicTo[{{senaite.baseUrl}}/@@API/senaite/v1/search?getClientSampleID=${exchangeProperty.service-request-id}&getClientID=${exchangeProperty.patient-uuid}&catalog=bika_catalog_analysisrequest_listing&complete=true]")
								.replace().toD("mock:senaiteClientsSampleSearchEndpoint");
				weaveByToString("DynamicTo[{{openmrs.baseUrl}}/ws/fhir2/R4/Task/${exchangeProperty.task-id}]").replace()
						.toD("mock:openmrsFhirTaskEndpoint");
				weaveByToString(
						"DynamicTo[{{openmrs.baseUrl}}/ws/rest/v1/encounter?encounterType={{results.encounterType.uuid}}&patient=${exchangeProperty.patient-uuid}&v=custom:(uuid,encounterDatetime,patient:(uuid),location:(uuid))]")
								.replace().toD("mock:openmrsPatientEncounterForResultsEndpoint");
				weaveByToString("DynamicTo[{{openmrs.baseUrl}}/ws/rest/v1/encounter]").replace()
						.toD("mock:openmrsEncounterCreationEndpoint");
				weaveByToString("DynamicTo[${exchangeProperty.analysis-api_url}]").replace()
						.toD("mock:senaiteAnalysisResultsEndpoint");
				weaveByToString("DynamicTo[{{openmrs.baseUrl}}/ws/rest/v1/obs]").replace()
						.toD("mock:openmrsObsCreationEndpoint");
			}
		});
	...
	private void setupExpectations() {
		...
		openmrsFhirServiceRequestEndpoint.expectedPropertyReceived("service-request-id",
				"f1e7ed13-5512-49b9-9d90-90dd66e8e397");
		...
		openmrsEncounterApiEndpoint.whenAnyExchangeReceived(new Processor() {
			...
			public void process(Exchange exchange) throws Exception {
				exchange.getIn().setBody(
						"{\"visit\":{\"uuid\":\"16301f3a-6ba1-498a-bcb1-13a1d20092b8\"},\"location\":{\"uuid\":\"833d0c66-e29a-4d31-ac13-ca9050d1bfa9\"},\"encounterDatetime\":\"2021-02-17T12:39:20.000+0000\"}");
			}
		...
		openmrsEncounterApiEndpoint.expectedPropertyReceived("service-request-encounter-reference",
				"ca51b8c1-3dba-44ba-99b1-9f04119130ad");
		...
		senaiteClientsSampleSearchEndpoint.expectedPropertyReceived("service-request-id",
				"f1e7ed13-5512-49b9-9d90-90dd66e8e397");
		senaiteClientsSampleSearchEndpoint.expectedPropertyReceived("patient-uuid",
				"8bd3db1d-533b-4e56-a945-b045bd9d3cb2");
		...
		openmrsFhirTaskEndpoint.expectedBodiesReceived(
				"{\"resourceType\": \"Task\", \"id\": \"15df1d72-f400-4428-b229-1febb94a6a9a\", \"status\": \"completed\", \"intent\": \"order\"}");
		...
		openmrsPatientEncounterForResultsEndpoint.expectedHeaderReceived("Authorization",
				"Basic c3VwZXJtYW46QWRtaW4xMjM=");
		openmrsPatientEncounterForResultsEndpoint.expectedPropertyReceived("patient-uuid",
				"8bd3db1d-533b-4e56-a945-b045bd9d3cb2");
		...
		openmrsEncounterCreationEndpoint.expectedPropertyReceived("service-request-location-uuid",
				"833d0c66-e29a-4d31-ac13-ca9050d1bfa9");
		openmrsEncounterCreationEndpoint.expectedPropertyReceived("service-request-encounter-datetime",
				"2021-02-17T12:39:20.000+0000");
		openmrsEncounterCreationEndpoint.expectedPropertyReceived("patient-uuid",
				"8bd3db1d-533b-4e56-a945-b045bd9d3cb2");
		openmrsEncounterCreationEndpoint.expectedPropertyReceived("service-request-visit-uuid",
				"16301f3a-6ba1-498a-bcb1-13a1d20092b8");
		openmrsEncounterCreationEndpoint.expectedPropertyReceived("service-request-requester",
				"1d0c6b21-60bd-11eb-afa0-0242ac18000a");
		openmrsEncounterCreationEndpoint.expectedBodiesReceived(
				"{\"location\": \"833d0c66-e29a-4d31-ac13-ca9050d1bfa9\",\"encounterType\": \"7aa974b5-7523-11eb-8077-0242ac120009\",\"encounterDatetime\": \"2021-02-17T12:39:20.000+0000\",\"patient\": \"8bd3db1d-533b-4e56-a945-b045bd9d3cb2\",\"visit\":\"16301f3a-6ba1-498a-bcb1-13a1d20092b8\", \"encounterProviders\":[{\"provider\": \"1d0c6b21-60bd-11eb-afa0-0242ac18000a\",\"encounterRole\": \"a0b03050-c99b-11e0-9572-0800200c9a66\"}]}");
